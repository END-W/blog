...
<section class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            ...
            <ol class="breadcrumb">
                <li><a href="javascript:;" onclick="deleteAll()">清除所有登录记录</a></li>
                <li><a href="javascript:;" onclick="deleteCurrent()">清除本人登录记录</a></li>
            </ol>
...
<script src="/blog/static/js/back/loginlog.js" type="text/javascript"></script>
</body>
</html>
