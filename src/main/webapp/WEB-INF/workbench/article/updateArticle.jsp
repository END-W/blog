...
<head>
    ...
    <link rel="stylesheet" href="/blog/static/bootstrap-3.3.7-dist/css/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="/blog/static/bootstrap-3.3.7-dist/css/bootstrap.min.css">
    <script src="/blog/static/bootstrap-3.3.7-dist/js/bootstrap.min.js"></script>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                ...
                                <p><label>公开度：</label><input id="open" type="radio" name="isOpen" value="1" />公开
                                    <input id="private" type="radio" name="isOpen" value="0"  />私密
                                </p>
                                <p><label>修改于：</label><span class="article-time-display" id="publishTime"></span></p>
                            </div>
...
<script>
    // 发送异步请求，查询当前文章信息
    $.post('/blog/article/queryById', {'aid': '${aid}'}, function (data) {
