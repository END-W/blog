                ...
                <form method="post" class="add-flink-form" autocomplete="off" draggable="false">
                    <div class="col-md-9">
                        ...
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                <textarea class="form-control" name="site_desc" autocomplete="off"></textarea>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                ...
                                <p><label>rel：</label><input type="radio" name="site_rel" value="nofollow" checked />nofollow&nbsp;&nbsp;<input type="radio" name="site_rel" value="none"/>none</p>
                                <p>
                                    <label>增加于：</label>
                            ...
                            <div class="add-article-box-footer">
                                <button class="btn btn-primary" type="button" onclick="publishLink()">增加</button>
                            </div>
                        </div>
                    </div>
                </form>
