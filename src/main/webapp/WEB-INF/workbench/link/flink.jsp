...
<section class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            ...
            <ol class="breadcrumb">
                <li><a href="/blog/toView/workbench/link/add-flink">增加友情链接</a></li>
            </ol>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <th><span class="glyphicon glyphicon-tag"></span> <span class="visible-lg">描述</span></th>
...
<script src="/blog/static/js/back/flink.js" type="text/javascript"></script>
</body>
</html>
