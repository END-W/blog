...
<head>
    ...
    <script src="/blog/static/js/jquery/jquery-2.1.1.min.js" type="text/javascript"></script>
    <link rel="stylesheet" type="text/css" href="/blog/static/bootstrap-3.3.7-dist/css/bootstrap.min.css">
    <script src="/blog/static/bootstrap-3.3.7-dist/js/bootstrap.js" type="text/javascript"></script>
    ...
    <div class="row">
        <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
            <ul class="nav nav-sidebar">
                <li class="active"><a href="/blog/toView/index">报告</a></li>
            </ul>
            <ul class="nav nav-sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            ...
            <div class="row placeholders">
                <div class="col-xs-6 col-sm-3 placeholder">
                    <h4>文章</h4>
                    <span id="titles" class="text-muted">0 条</span></div>
                <div class="col-xs-6 col-sm-3 placeholder">
                    <h4>评论</h4>
                    <span id="comments" class="text-muted">0 条</span></div>
                <div class="col-xs-6 col-sm-3 placeholder">
                    <h4>点赞数</h4>
                    <span id="thumbsUp" class="text-muted">0</span></div>
                <div class="col-xs-6 col-sm-3 placeholder">
                    <h4>访问量</h4>
                    <span id="visitCount" class="text-muted">0</span></div>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        <td>上次登录时间: ${sessionScope.lastLoginTime} , 上次登录IP: ${sessionScope.loginIp}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        <td>登录者IP:</td>
                        <td>${sessionScope.user.loginIp}</td>
                        <td>MYSQL版本:</td>
                        <td>5.5.40</td>
                    </tr>
                    <tr>
                        <td>程序版本:</td>
                        <td class="version">END V.1.0.0 <font size="-6" color="#BBB">(20211101)</font></td>
                        <td>上传文件:</td>
                    ...
                    <tr>
                        ...
                        <td>UTF-8</td>
                        <td>当前登录时间:</td>
                        <td>${sessionScope.user.lastLoginTime}</td>
                    </tr>
                    </tbody>
                    <tfoot>
                    <tr></tr>
...
<script>
    // 异步查询信息总览
    $.post('/blog/article/queryInfoOverview', function (data) {
        $('#comments').html(data.comments + ' 条');
        $('#titles').html(data.title + ' 条');
        $('#thumbsUp').html(data.thumbsUp);
        $('#visitCount').html(data.visit_count);
    }, 'json');

    // 异步查询管理员人数
    $.post('/blog/user/queryCount', function (data) {
        $('#manger').html(data);
    }, 'text');
</script>
